                ...
                <Box1>
                    <Box sx={{display: 'flex', flexDirection: 'row', p: 1, m: 1}}>
                        <Item sx={{
                            ...
                            <Typography variant='h6' component='h4' sx={{fontSize: '1rem'}}>تخفیف بیشتر
                                محصولات</Typography>
                            <Typography variant="body2" color="gray"
                                        sx={{fontSize: '0.8rem', marginTop: '0.3rem'}}> کالاها با قیمت کمتر از درج شده
                                ارسال می‌شود</Typography>
                        </Item>
                        <Item sx={{
                            order: 2,
                            display: 'flex',
                            ...
                            <Typography variant='h6' component='h4' sx={{fontSize: '1rem'}}>ارسال به موقع
                                سفارش‌ها</Typography>
                            <Typography variant="body2" color="gray" sx={{fontSize: '0.8rem', marginTop: '0.3rem'}}>سفارشات
                                شما در زمان مقرر ارسال می‌شود</Typography>
                        </Item>
                    </Box>
                    <Box sx={{display: 'flex', flexDirection: 'row', p: 1, m: 1}}>
                        <Item sx={{
                            ...
                            <Typography variant='h6' component='h4' sx={{fontSize: '1rem'}}>ارسال بهترین
                                کالاها</Typography>
                            <Typography variant="body2" color="gray" sx={{fontSize: '0.8rem', marginTop: '0.3rem'}}>محصولات
                                ارسالی از بین بهترین‌ها گلچین می‌شود</Typography>
                        </Item>
                        <Item sx={{
                            order: 4,
                            display: 'flex',
                            ...
                            <Typography variant="body2" color="gray" sx={{fontSize: '0.8rem', marginTop: '0.3rem'}}>سفارشات
                                با بسته‌بندی مناسب ارسال می‌شود</Typography>
                        </Item>
                    </Box>
                </Box1>
                ...
                <Grid container spacing={1}>
                    <Grid item md={5} sm={8} lg={5} sx={{p: 1, m: 1}}>
                        <Box sx={{
                            ...
                            <Typography variant='h6' component='h4' sx={{fontSize: '1rem', mx: 2}}>دانلود
                                اپلیکیشن</Typography>
                        ...
                        <Box sx={{display: 'flex', flexDirection: 'row', marginLeft: 0}}>
                            <Item md={3} lg={3} sx={{
                                ...
                                <Typography variant='body2' component='p' color='gray'
                                            sx={{lineHeight: '1.5rem', width: '18rem', marginTop: '1rem'}}>اسنپ مارکت
                                    حاصل همکاری دو شرکت بزرگ اسنپ و‌هایپراستار است تا کالاهای مورد نیاز کاربران را در
                                    اسرع وقت برای آنها ارسال کند.</Typography>
                                <Typography variant='body2' component='span' color='gray'
                                            sx={{lineHeight: '1.5rem', marginBottom: '1.5rem'}}>هایپر استار |
                                    مایلی</Typography>
                            </Item>
                            <Item sx={{m: 2, px: 2}}>
                                <Typography variant='h6' component='h4'
                                            sx={{fontSize: '1rem', lineHeight: '1.5rem'}}>دسترسی‌ها</Typography>
                                <Box sx={{
                                    display: 'flex',
                                    flexDirection: 'column',
                                    typography: 'body2',
                            ...
                            <Item sx={{
                                ...
                                <Typography variant='h6' component='h4' sx={{fontSize: '1rem', lineHeight: '1.5rem'}}>تماس
                                    با ما</Typography>
                                <Box sx={{
                                    display: 'flex',
                                    flexDirection: 'column',
                                    ...
                                    <Typography variant='body2' component='span' color='gray'
                                                sx={{lineHeight: '1.5rem'}}>تلفن:۰۲۱۹۶۶۱۲۶۰۰ </Typography>
                                    <Typography variant='body2' component='span' color='gray'
                                                sx={{lineHeight: '1.5rem'}}> آدرس: خیابان ولیعصر بالاتر از اسفندیار
                                        خیابان سعیدی نبش کوچه مهردادپلاک۱ طبقه</Typography>
                                    <Typography variant='body2' component='span' color='gray'
                                                sx={{lineHeight: '1.5rem'}}>ایمیل : info@snapp.market</Typography>
                                    <Typography variant='body2' component='span' color='gray'
                                                sx={{lineHeight: '1.5rem'}}>کد پستی: ۱۹۶۷۸۶۵۶۳۱ </Typography>
                                </Box>
